...
export function CalendarUpcomingCard({
  ...
  return (
    <section className="dashboard-preview__card dashboard-preview__card--calendar" aria-label="Calendar and upcoming events">
      <header className="dashboard-preview__card-head dashboard-preview__card-head--row">
        <div>
          ...
          <p className="dashboard-preview__meta">Mini month and agenda</p>
        </div>
      ...
      <div className="dashboard-preview__calendar-upcoming-body">
        <div className="dashboard-preview__calendar-panel">
        ...
        <aside className="dashboard-preview__upcoming-panel" aria-label="Upcoming events">
          <p className="dashboard-preview__upcoming-label">Upcoming</p>
          <p className="dashboard-preview__upcoming-heading">{upcomingAgendaHeading}</p>
