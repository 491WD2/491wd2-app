...
export const DS_CARD =
  "rounded-2xl border border-white/[0.12] bg-[#0B0F14] shadow-[0_20px_60px_rgba(0,0,0,0.35)] transition-colors hover:border-white/[0.14]";

export const DS_CARD_COMPACT =
  "rounded-2xl border border-white/[0.12] bg-[#0B0F14] shadow-[0_20px_60px_rgba(0,0,0,0.35)] transition-colors";

export const DS_CARD_RAISED =
  "rounded-2xl border border-white/[0.12] bg-[#10161D] shadow-[0_20px_60px_rgba(0,0,0,0.35)] transition-colors";
...
export const DS_INPUT =
  "w-full min-h-[44px] rounded-xl border border-white/[0.14] bg-[#1B2028] px-3 py-2.5 text-[17px] leading-snug text-[#F8FAFC] shadow-inner shadow-black/20 outline-none transition placeholder:text-[#94A3B8] focus:border-[#00B7C7]/60 focus:ring-2 focus:ring-[#00B7C7]/35 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50";
