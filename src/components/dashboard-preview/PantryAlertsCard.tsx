...
export function PantryAlertsCard({
  ...
  return (
    <section className="dashboard-preview__card" aria-label="Pantry and storage">
      <header className="dashboard-preview__card-head dashboard-preview__card-head--row">
        <div>
          ...
          <p className="dashboard-preview__meta">Household food storage</p>
        </div>
      ...
      <div className="dashboard-preview__pantry-stats">
      ...
      {storageZoneStats ? (
        <div className="dashboard-preview__pantry-zones" aria-label="Storage summary">
          <button
            type="button"
