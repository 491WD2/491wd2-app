...
export function NotionHomeWorkspace({
  ...
  return (
    <NotionPageCanvas className="fh-figma-theme fh-notion-page fh-notion-home fh-smart-home fh-fridge-home fh-fridge-home--tablet fh-start-page fh-pro-page fh-home-pro">
